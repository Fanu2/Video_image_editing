...
def create_animation(input_folder, output_video):
    ...
    video_clip = ImageSequenceClip(clips, fps=2)

    # Calculate duration based on number of frames (each frame contributes 1/2 second)
    duration = len(clips) / 2  # Assuming 2 frames per second
